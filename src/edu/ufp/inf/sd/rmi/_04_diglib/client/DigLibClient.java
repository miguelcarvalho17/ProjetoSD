...
public class DigLibClient {
    ...
    private void playService() {
        try {
            ...
            this.DigLibFactoryRI.register("Joao Melo", "1234");
            DigLibSessionRI digLibSessionRI = this.DigLibFactoryRI.login("Joao Melo", "1234");

            Book[] books;
            books = digLibSessionRI.search("Distributed Systems: principles and paradigms", "Tanenbaum");
            for (Book b : books) {
