...
public class VisitorServer {
    ...
    public static void main(String[] args) {
        if (args != null && args.length < 3) {
            ...
            //1. ============ Create Servant ============
            edu.ufp.inf.sd.rmi._06_visitor.server.VisitorServer hws = new edu.ufp.inf.sd.rmi._06_visitor.server.VisitorServer(args);
    ...
    private void rebindService() {
        try {
            ...
            if (registry != null) {
                ...
                elementFolderRI= new ConcreteElementFolderBooksImpl("/Users/miguelcarvalho/IdeaProjects/SD/src/edu/ufp/inf/sd/rmi/_06_visitor/Books");
