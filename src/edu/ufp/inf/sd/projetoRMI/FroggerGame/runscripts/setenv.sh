...
#@REM =====================================================================================================
# @REM ==== PC STUFF ====
export JDK=/Library/Java/JavaVirtualMachines/jdk1.8.0_291.jdk/Contents/Home
...
export USERNAME=miguelcarvalho


#@REM ==== JAVA NAMING STUFF ====
export JAVAPROJ_NAME=SD
export JAVAPROJ=/Users/miguelcarvalho/IdeaProjects/SD

export PACKAGE=FroggerGame
export PACKAGE_PREFIX=edu.ufp.inf.sd.projetoRMI
export PACKAGE_PREFIX_FOLDERS=edu/ufp/inf/sd/projetoRMI
export SERVICE_NAME_ON_REGISTRY=FroggerGameService
...
export JIG_JAR_CP=${JAVAPROJ_DIST_LIB}/jig-1.7.5.jar
...
export CLASSPATH=.:${JAVAPROJ_CLASSES_FOLDER}:/Users/miguelcarvalho/IdeaProjects/SD/lib/jig-1.7.5.jar
